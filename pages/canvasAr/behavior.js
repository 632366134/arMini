import { createScopedThreejs ,OrbitControls} from "threejs-miniprogram";
    ...
    methods: {
      ...
      loading(THREE) {
        return new Promise((resolve, reject) => {
          ...
          wx.request({
            url: `https://wxminiapp.arsnowslide.com/arPcCustomerWeb/resource/showResource?comSessCode=${code}`,
            data: {
          ...
          loader.load(
            ...
            (xhr, loaded, total) => {
              console.log(xhr, loaded, total);
              console.log(
                "加载进度" + Math.floor((loaded / total) * 100) + "%"
              );
            }
          );
        });
